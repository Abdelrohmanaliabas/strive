...
@section('content')
<x-admin.module-frame title="User Management" eyebrow="Users"
    ...
    <div class="space-y-8">
        ...
        <form method="GET" action="{{ route('admin.users.index') }}"
            ...
            <div>
                <select name="role"
                    class="rounded-md border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white px-4 py-2 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div
                class="card block rounded-lg border border-gray-200 dark:border-gray-700 p-5 shadow-sm hover:shadow-md transition bg-gray-50 dark:bg-gray-700">
  ...
  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                ...
                <div class="details px-5">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm mb-2 flex ">
                        <i class="bi bi-envelope me-1"></i> {{ $user->email }}
                    </p>

                    <p class="text-gray-600 dark:text-gray-300 text-sm mb-4 capitalize flex">
                        <i class="bi bi-person-badge me-1"></i> {{ $user->role ?? 'User' }}
                    </p>

                    <p class="text-gray-600 dark:text-gray-300 text-sm mb-2 flex">
                        <a href="{{ $user->linkedin_url }}" target="_blank" class="flex items-center">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('admin.users.edit', $user->id) }}"
                        class="inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-white bg-yellow-600 hover:bg-yellow-500 rounded-md transition">
